...
public class StringCalc {
    public static void main(String[] args){
        ...
        while (Objects.equals(myArray[2], "-")) {
            ...
            if(sravn) {
                String part3 = myArray[3];
                String part = part1.replaceAll("[" + Pattern.quote(part3) + "]","");
                System.out.println("Разница строк: " + part);
                break;
            } else {
        ...
        if (matcherPart0.find() && myArray[2].length() == 3) {
            ...
            int intpart23 = Integer.parseInt(String.valueOf(myArray[2].charAt(2)));//проверка на 0
            if(intpart23 != 0 || intpart21 != 1){
